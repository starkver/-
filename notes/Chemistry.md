...
# ТЕМА:  Классификация,  номенклатура, теория химического строения органических соединений, кислотность, основность органических соединений
## Знать понятия  «функциональная группа», «углеводородный радикал»,  «монофункциональные», «полифункциональные», «гетерофункциональные»;  «карбоциклические», «гетероциклические» соединения, явление изомерии, изомеры; структурные формулы  и тривиальные названия первых пяти представителей  гомологического ряда спиртов, альдегидов, кетонов, монокарбоновых кислот и  четырех представителей дикарбоновых кислот (щавелевая, малоновая, янтарная, глутаровая)

**Функциональная группа** - атом или группа атомов в молекуле, определяющая основные химические св-ва и реакции этого соединения
В состав ФГ обязательно  входит гетероатом (**гетероатом**-  атом неметалла, например кислород О, азот_N, фосфор Р, но не углерод  и не водород).
**Углеводный радикал** - часть молекулы, состоящая из атомов углерода и водорода(СН<sub>3</sub>- метил, С<sub>2</sub>Н<sub>5</sub>-этил и т.д)
**Монофункциональные соединения** - одна функциональная группа
**Полифункциональные соединения** - несколько одинаковых функциональных групп
**Гетерофункциональные соединения** - несколько различных функциональных групп
**Карбоциклические соединения** - органическое соединение, состоящее из цикла атомов углерода 
**Гетероциклические соединения** - органические соединения, состоящие из цикла атомов углерода и др. хим эл-ов.
**Явление изомерии** - явление существования изомеров, имеющих одинаковую молекулярную формулу, но разное строение или пространственное расположение атомов
**Изомеры** - органические соединения с одинаковой формулой, но разные по расположению атомов


![](notes/images/chemistry/изомерия.PNG)


**Структурная изомерия:** 


![](notes/images/chemistry/изомеры.PNG)


**Пространственная изомерия:** 
1) *Цис-транс изомерия* - характерна для соединений, содержащих двойную связь или цикл. В таких молекулах отсутствует свободное вращение вокруг связи С = С или С – С (в циклах) и заместители у двух соседних атомов углерода могут оказаться по одну сторону _(цис-)_ или по разные стороны _(транс-)_ от плоскости, проходящей через двойную связь


   ![](notes/images/chemistry/цистранс.png)

   
3) *Оптическая изомерия* - молекулы имеют одинаковую форму и структуру, но отличаются пространственным расположением атомов. Характерна для в-в с асимметричным атомом углерода(**хиральный центр** - атом в молекуле, вокруг которого располагаются *четыре разные группы*)
   *Хиральность* - свойство объекта не совпадать со своим зеркальным отражением

   
   ![](notes/images/chemistry/оптическаяизом.png)

   
**Спирты (R-OH):** 

| №   | Название (тривиальное) | Формула | Структурная формула    |
| --- | ---------------------- | ------- | ---------------------- |
| 1   | Метоанол               | CH₄O    | CH₃ – OH               |
| 2   | Этанол                 | C₂H₆O   | CH₃–CH₂–OH             |
| 3   | Пропанол- 1            | C₃H₈O   | CH₃–CH₂–CH₂–OH         |
| 4   | Бутанол- 1             | C₄H₁₀O  | CH₃–CH₂–CH₂–CH₂–OH     |
| 5   | Пентанол- 1            | C₅H₁₂O  | CH₃–CH₂–CH₂–CH₂–CH₂–OH |

**Альдегиды(R-CHO):**

| №   | Название (тривиальное) | Формула                      | Структурная формула |
| --- | ---------------------- | ---------------------------- | ------------------- |
| 1   | Формальдегид           | CH<sub>2</sub>O              | H–CHO               |
| 2   | Ацетальдегид           | C<sub>2</sub>H<sub>4</sub>O  | CH₃–CHO             |
| 3   | Пропионовый альдегид   | C<sub>3</sub>H<sub>6</sub>O  | CH₃–CH₂–CHO         |
| 4   | Масляный альдегид      | C<sub>4</sub>H<sub>8</sub>O  | CH₃–CH₂–CH₂–CHO     |
| 5   | Валериановый альдегид  | C<sub>5</sub>H<sub>10</sub>O | CH₃–CH₂–CH₂–CH₂–CHO |

**Кетоны(R–CO–R'):**

| №   | Название (тривиальное) | Формула | Структурная формула  |
| --- | ---------------------- | ------- | -------------------- |
| 1   | Ацетон                 | C₃H₆O   | CH₃–C(O)–CH₃         |
| 2   | Метилэтилкетон         | C₄H₈O   | CH₃–C(O)–CH₂–CH₃     |
| 3   | Диэтилкетон            | C₅H₁₀O  | CH₃–CH₂–C(O)–CH₂–CH₃ |
| 4   | Метилпропилкетон       | C₅H₁₀O  | CH₃–C(O)–CH₂–CH₂–CH₃ |
| 5   | Диметилэтилкетон       | C₆H₁₂O  | CH₃–CH(CH₃)–C(O)–CH₃ |

**Монокарбоновые кислоты(R–COOH):**

| №   | Название (тривиальное) | Формула | Структурная формула  |
| --- | ---------------------- | ------- | -------------------- |
| 1   | Муравьиная(формиат)    | CH₂O₂   | H–COOH               |
| 2   | Уксусная(ацетат)       | C₂H₄O₂  | CH₃–COOH             |
| 3   | Пропионовая            | C₃H₆O₂  | CH₃–CH₂–COOH         |
| 4   | Масляная               | C₄H₈O₂  | CH₃–CH₂–CH₂–COOH     |
| 5   | Валериановая           | C₅H₁₀O₂ | CH₃–CH₂–CH₂–CH₂–COOH |

**Дикарбоновые кислоты(HOOC–(CH₂)n–COOH):**

| №   | Название (тривиальное) | Формула | Структурная формула   |
| --- | ---------------------- | ------- | --------------------- |
| 1   | Щавелевая(оксаловая)   | C₂H₂O₄  | HOOC–COOH             |
| 2   | Малоновая              | C₃H₄O₄  | HOOC–CH₂–COOH         |
| 3   | Янтарная               | C₄H₆O₄  | HOOC–CH₂–CH₂–COOH     |
| 4   | Глутаровая             | C₅H₈O₄  | HOOC–CH₂–CH₂–CH₂–COOH |
...
![](notes/images/chemistry/производуглеводород.png)


![](notes/images/chemistry/заместит.png)


![](notes/images/chemistry/углеводородрадик.png)
