...
2) *Оптическая изомерия* - молекулы имеют одинаковую форму и структуру, но отличаются пространственным расположением атомов. Характерна для в-в с асимметричным атомом углерода(**хиральный центр** - атом в молекуле, вокруг которого располагаются *четыре разные группы*)
