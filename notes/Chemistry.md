...
3. $$ 
\begin{array}
\text{Молярная } \text{ }{концентрация} \text{ }{эквивалента}\text{ } c\left(\frac{1}{z}x\right)\text{ — величина,равная отношению}\\
\end{array}
$$
$$
\text{кол-ва вещества-эквивалента } n\left(\frac{1}{z}x\right)\text{ к объёму раствора}:
$$
$$
